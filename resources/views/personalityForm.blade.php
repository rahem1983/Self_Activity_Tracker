                ...
                <h6 class="pt-1 text-center"style="text-decoration: none;">Which word in each pair appeals to you more? <br>
                 ...
                 <div class="row">
                   <div class="col-6">
                    <div class="form-group pt-2">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="39" id="inlineRadio1" value="t1">
                        <label class="form-check-label" for="inlineRadio1">A. DETERMINED</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="39" id="inlineRadio2" value="f1">
                    ...
                    <div class="form-group pt-2">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="40" id="inlineRadio1" value="f1">
                        <label class="form-check-label" for="inlineRadio1">A. GENTLE</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="40" id="inlineRadio2" value="t2">
                      ...
                      <div class="form-group pt-2">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="41" id="inlineRadio1" value="j2">
                          <label class="form-check-label" for="inlineRadio1">A. SYSTEMATIC</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="41" id="inlineRadio2" value="p2">
                      ...
                      <div class="form-group pt-2">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="42" id="inlineRadio1" value="s1">
                          <label class="form-check-label" for="inlineRadio1">A. CERTAINTY</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="42" id="inlineRadio2" value="n2">
                      ...
                      <div class="form-group pt-2">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="43" id="inlineRadio1" value="i1">
                          <label class="form-check-label" for="inlineRadio1">A. CALM</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="43" id="inlineRadio2" value="e1">
                      ...
                      <div class="form-group pt-2">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="44" id="inlineRadio1" value="t1">
                          <label class="form-check-label" for="inlineRadio1">A. JUSTICE</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="44" id="inlineRadio2" value="f2">
                 ...
                 <div class="col-6">
                    <div class="form-group pt-2">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="45" id="inlineRadio1" value="n0">
                        <label class="form-check-label" for="inlineRadio1">A. FASCINATING</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="45" id="inlineRadio2" value="s2">
                  ...
                  <div class="form-group pt-2">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="46" id="inlineRadio1" value="t2">
                      <label class="form-check-label" for="inlineRadio1">A. FIRM-MINDED</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="46" id="inlineRadio2" value="f0">
                      ...
                      <div class="form-group pt-2">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="47" id="inlineRadio1" value="f1">
                          <label class="form-check-label" for="inlineRadio1">A. FEELING</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="47" id="inlineRadio2" value="t2">
                      ...
                      <div class="form-group pt-2">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="48" id="inlineRadio1" value="s1">
                          <label class="form-check-label" for="inlineRadio1">A. LITERAL</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="48" id="inlineRadio2" value="n1">
                      ...
                      <div class="form-group pt-2">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="49" id="inlineRadio1" value="t2">
                          <label class="form-check-label" for="inlineRadio1">A. ANTICIPATION</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="49" id="inlineRadio2" value="f1">
                      ...
                      <div class="form-group pt-2">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="50" id="inlineRadio1" value="t2">
                          <label class="form-check-label" for="inlineRadio1">A. HARD</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="50" id="inlineRadio2" value="f0">
