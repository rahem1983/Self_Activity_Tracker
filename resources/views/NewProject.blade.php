        ...
        <form style="color:#002db3 ">
            <div class="form-row pt-4">
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="title" placeholder="Name of your project">
              </div>
            </div>
            ...
            <div class="form-row pt-4">
              ...
              <div class="pt-5 text-center">
                <button type="submit" class="btn btn-primary" style="background-color: #002db3">Sign in</button>
              </div>
